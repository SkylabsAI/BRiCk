...
Module Type CPP_PHYSICAL.
  Context `{cpp_logic}.

  Parameter byte_at : forall (hpa:paddr) (hpaFrac : Qp) (value : byte), mpred.

End CPP_PHYSICAL.

Definition ASID : biIndex := BiIndex vaddr _ eq _.
...
Section asid_bi.
  ...
  Definition vbyte (va : vaddr) (v: byte) : mpred :=
    monPred2_embed L_ASID (vbyte' va v).
