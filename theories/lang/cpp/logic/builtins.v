...
Section with_Σ.
  ...
  Definition ffs_spec (sz : bitsize) (n : Z) (Q : val -> mpred) : mpred :=
    [| has_type (Vint n) (Tnum sz Signed) |] ** Q (Vint (first_set (bitsN sz) n)).
  ...
  Definition ctz_spec (sz : bitsize) (n : Z) (Q : val -> mpred) : mpred :=
    [| has_type (Vint n) (Tnum sz Unsigned) |] ** [| n <> 0 |] ** Q (Vint (trailing_zeros (bitsN sz) n)).
  ...
  Definition clz_spec (sz : bitsize) (n : Z) (Q : val -> mpred) : mpred :=
    [| has_type (Vint n) (Tnum sz Unsigned) |] ** [| n <> 0 |] ** Q (Vint (leading_zeros (bitsN sz) n)).
