...
Section with_Σ.
  ...
  Lemma wp_unreachable : forall Q,
      False |-- BUILTIN Bin_unreachable (Tfunction Tvoid []) nil Q.
  Proof. intros. iIntros "[]". Qed.

  Lemma wp_trap : forall Q,
      False |-- BUILTIN Bin_trap (Tfunction Tvoid []) nil Q.
  Proof. intros. iIntros "[]". Qed.

  Axiom wp_expect : forall exp c Q,
      Q exp |-- BUILTIN Bin_expect (Tfunction (Tint W64 Signed) [Tint W64 Signed;Tint W64 Signed]) (exp :: c :: nil) Q.
  ...
  Axiom wp_ffs : forall sz c Q,
          ffs_spec sz c Q
      |-- BUILTIN Bin_ffs (Tfunction (Tint sz Signed) [Tint sz Signed]) (Vint c :: nil) Q.

  Axiom wp_ffsl : forall sz c Q,
          ffs_spec sz c Q
      |-- BUILTIN Bin_ffsl (Tfunction (Tint sz Signed) [Tint sz Signed]) (Vint c :: nil) Q.

  Axiom wp_ffsll : forall sz c Q,
          ffs_spec sz c Q
      |-- BUILTIN Bin_ffsll (Tfunction (Tint sz Signed) [Tint sz Signed]) (Vint c :: nil) Q.
  ...
  Axiom wp_ctz : forall sz c Q,
          ctz_spec sz c Q
      |-- BUILTIN Bin_ctz (Tfunction (Tint sz Unsigned) [Tint sz Unsigned]) (Vint c :: nil) Q.

  Axiom wp_ctzl : forall sz c Q,
          ctz_spec sz c Q
      |-- BUILTIN Bin_ctzl (Tfunction (Tint sz Unsigned) [Tint sz Unsigned]) (Vint c :: nil) Q.

  Axiom wp_ctzll : forall sz c Q,
          ctz_spec sz c Q
      |-- BUILTIN Bin_ctzll (Tfunction (Tint sz Unsigned) [Tint sz Unsigned]) (Vint c :: nil) Q.
  ...
  Axiom wp_clz : forall sz c Q,
          clz_spec sz c Q
      |-- BUILTIN Bin_clz (Tfunction (Tint sz Unsigned) [Tint sz Unsigned]) (Vint c :: nil) Q.

  Axiom wp_clzl : forall sz c Q,
          clz_spec sz c Q
      |-- BUILTIN Bin_clzl (Tfunction (Tint sz Unsigned) [Tint sz Unsigned]) (Vint c :: nil) Q.

  Axiom wp_clzll : forall sz c Q,
          clz_spec sz c Q
      |-- BUILTIN Bin_clzll (Tfunction (Tint sz Unsigned) [Tint sz Unsigned]) (Vint c :: nil) Q.
  ...
  Axiom wp_bswap16 : forall x Q,
      ...
      |-- BUILTIN Bin_bswap16 (Tfunction (Tint W16 Unsigned) [Tint W16 Unsigned])
          (Vint x :: nil) Q.

  Axiom wp_bswap32 : forall x Q,
          [| has_type (Vint x) (Tint W32 Unsigned) |] ** Q (Vint (bswap W32 x))
      |-- BUILTIN Bin_bswap32 (Tfunction (Tint W32 Unsigned) [Tint W32 Unsigned])
          (Vint x :: nil) Q.

  Axiom wp_bswap64 : forall x Q,
          [| has_type (Vint x) (Tint W64 Unsigned) |] ** Q (Vint (bswap W64 x))
      |-- BUILTIN Bin_bswap64 (Tfunction (Tint W64 Unsigned) [Tint W64 Unsigned])
          (Vint x :: nil) Q.

  Axiom wp_bswap128 : forall x Q,
          [| has_type (Vint x) (Tint W128 Unsigned) |] ** Q (Vint (bswap W128 x))
      |-- BUILTIN Bin_bswap128 (Tfunction (Tint W128 Unsigned) [Tint W128 Unsigned])
          (Vint x :: nil) Q.
  ...
  Axiom wp_launder : forall ty res newp Q,
      ...
      |-- BUILTIN Bin_launder (Tfunction (Tptr Tvoid) [Tptr Tvoid])
          (Vptr res :: nil) Q.
