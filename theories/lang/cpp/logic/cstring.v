...
Require Import bedrock.lang.cpp.algebra.cv.
...
Module cstring.
  ...
  Section with_Σ.
    ...
    Definition bufR (q : CV.t) (sz : Z) (cstr : t) : Rep :=
    (* The toplevel definition of [cstring.bufR']: *)
    ...
    Lemma bufRs_equiv (q : CV.t) (sz : Z) (zs : t) :
    ...
    Definition R (q : CV.t) (cstr : t) : Rep :=
    ...
    Section Theory.
      ...
      Section bufR.
        ...
        #[global] Instance bufR_singleton :
          forall (q : CV.t) (sz : Z) (b : Byte.byte),
            1 <= sz ->
        ...
        Lemma bufR_cons :
          forall (q : CV.t) (sz : Z) (b : Byte.byte) (cstr : t),
            b <> "000"%byte ->
        ...
        #[global] Instance bufR_cons_cons_head_nonzero :
          forall (q : CV.t) (sz : Z) (b b' : Byte.byte) (cstr : t),
      ...
      Section R.
        ...
        Lemma R_cons :
          forall (q : CV.t) (b : Byte.byte) (cstr : t),
            b <> "000"%byte ->
        ...
        #[global] Instance R_cons_cons_head_nonzero :
          forall (q : CV.t) (b b' : Byte.byte) (cstr : t),
      ...
      Section Extra.
        Lemma R_to_zstringR (q : CV.t) (cstr : t) : R q cstr |-- zstring.R q (to_zstring cstr).
        Proof. by []. Qed.

        Lemma R_from_zstringR (q : CV.t) (zs : zstring.t) :
