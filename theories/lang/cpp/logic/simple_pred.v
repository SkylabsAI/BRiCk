...
Module SimpleCPP.
  ...
  Section with_cpp.
    ...
    Proof. rewrite -embed_only_provable. apply _. Qed.
    ...
    Proof.
      iIntros "B". iMod (own_update with "B") as "$"; last done.
    ...
    Proof.
      ...
      rewrite -embed_sep -own_op singleton_op.
      rewrite own_valid uPred.discrete_valid singleton_valid.
