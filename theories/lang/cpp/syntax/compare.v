...
Module Expr.
  Section compare_body.
    ...
    Definition compare_body (e : Expr) : Expr -> comparison :=
      ...
      | Emember_ignore arr e n => compare_ctor (Reduce (tag (Emember_ignore arr e n))) (fun _ => Reduce (data (Emember_ignore arr e n)))
      ...
      | Elambda n es => compare_ctor (Reduce (tag (Elambda n es))) (fun _ => Reduce (data (Elambda n es)))
      ...
      | Einitlist_union es i t => compare_ctor (Reduce (tag (Einitlist_union es i t))) (fun _ => Reduce (data (Einitlist_union es i t)))
