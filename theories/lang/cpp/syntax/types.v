...
Succeed Example TEST_drop_reference : drop_reference (Qconst Tint) = Qconst Tint := eq_refl.
Succeed Example TEST_drop_reference : drop_reference (Qconst (Tref Tint)) = Tint := eq_refl.
Succeed Example TEST_drop_reference : drop_reference (Qconst (Tref (Qconst Tint))) = Qconst Tint := eq_refl.
