...
Module canonical_tu.
  Definition im_to_gmap {V} (m : IM.t V) : gmap SmallStr.t V :=
    list_to_map (map_to_list m).
  Definition symbol_table_canon : Set := gmap SmallStr.t ObjValue.
  Definition type_table_canon : Set := gmap SmallStr.t GlobDecl.
